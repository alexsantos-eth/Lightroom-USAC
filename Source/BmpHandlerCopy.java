...
public class BmpHandlerCopy extends ImageHandler {
	...
	/**
	 * Builds and returns a BmpHandlerCopy object which handles the file represented
	 * by the given name
	 * 
	...
	/**
	 * Generates a copy file from the original file. The name of the generated file
	 * will be build by the same name preceeded of "copy-"
	 **/
